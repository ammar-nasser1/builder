<template>
  <div class="w-[100%] flex flex-col items-center justify-center">
    <div
      class="bg-white mb-[50px] xl:h-[100px] md:h-[70px] w-[100%] flex justify-center"
    >
      <div class="flex w-[96%]">
        <div class="w-[60%] flex justify-start items-center gap-3">
          ...
          <div dir="rtl" class="xl:w-[60%] md:w-[40%] flex justify-start">
            <form class="w-full">
              <div class="relative">
                <div
        ...
        <div
          class="w-[40%] flex flex-col xl:h-[100px] md:h-[70px] justify-evenly text-right"
        >
          <div class="flex md:gap-2 xl:gap-3 justify-end md:text-[12px]">
      ...
      >
        ...
        >
          <div class="flex flex-row justify-between">
            ...
            <div class="card-name flex items-center justify-center">مباعة</div>
          </div>
