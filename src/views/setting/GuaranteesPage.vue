<template>
  <div class="w-[100%] flex flex-col items-center justify-center">
    ...
    <div class="w-[96%] flex flex-col items-center">
      ...
      <div class="w-[100%]" v-show="this.TableState === 1">
        <div
      ...
      <div class="w-[100%]" v-show="this.TableState === 2">
        <div
          class="relative overflow-x-auto shadow-md sm:rounded-lg mt-2 border border-green-400 dark:border-gray-700"
        >
          <div
          ...
          >
            ...
            >
              <button
                ...
                class="border-[#3C757D] border text-teal-600 rounded-[8px] px-4 py-2 ml-2"
              >
                تغيير ألوان الايقونات
              </button>
              <div
                class="modal fade"
                id="exampleModal"
                          ...
                          <div class="input-wrapper w-[45%]">
                            ...
                            >
                              <input
                                type="color"
                                id="inputField"
                                class="border border-white h-7 w-7 block bg-white cursor-pointer rounded-lg"
                              />
                              <label for="inputField"> اختر لون </label>
                            </div>
                          </div>
                          <div class="input-wrapper w-[45%]">
