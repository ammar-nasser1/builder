  ...
  <div class="w-[100%] flex flex-col items-center justify-center">
    ...
    <div class="w-[96%] flex flex-col items-center">
      <div class="flex flex-col items-end bg-white rounded-xl mt-12">
        ...
        >
          <div
            class="pr-5 flex items-center justify-end w-full"
            style="
        ...
        <div class="flex justify-around">
          <div class="w-[35%] flex justify-center items-center">
            <img src="/img/icons/company-name.png" alt="" />
          </div>

          <div
            class="w-[60%] flex justify-end gap-5 items-center flex-wrap py-5"
          >
