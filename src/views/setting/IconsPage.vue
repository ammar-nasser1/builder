  ...
  <div class="w-[100%] flex flex-col items-center justify-center">
    <div class="bg-white mb-[50px] h-[100px] w-[100%] flex justify-center">
      <div class="flex w-[96%]">
        ...
        <div
          class="w-[40%] flex flex-col h-[100px] justify-evenly text-right md:text-[12px] xl:text-[16px]"
        >
          <div class="flex gap-2 justify-end">
            <span>المستوى الثالث</span>
            <span>&lt;</span>
            <span class="text-[#2F6FED]">المستوى الثاني</span> <span>&lt;</span>
            <span class="text-[#2F6FED]">المستوى الأول</span>
          </div>

          <div>
            <h1>قائمة الايقونات</h1>
          </div>
        </div>
      </div>
    </div>
    <div class="w-[96%] flex flex-col items-center">
      ...
      >
        <div
          class="w-[100%] md:w-[33%] h-[150px] bg-[#FFFFFF] flex flex-col justify-evenly px-[18px] py-2 rounded-[16px]"
        >
        ...
        <div
          class="w-[100%] md:w-[33%] h-[150px] bg-black text-white flex flex-col justify-evenly px-[18px] py-2 rounded-[16px]"
        >
          <div class="flex flex-row justify-between">
            <div
              class="w-[72px] h-[28px] rounded-[8px] bg-white text-black flex items-center justify-center"
              style="
                font-family: Montserrat-Arabic;
                font-size: 14px;
                font-weight: 400;
          ...
          <div class="card-num text-white">10</div>
          <div class="card-foot">مقارنة بالشهر السابق (750)</div>
        </div>
      </div>
      ...
      <div class="w-[100%] bg-white mt-5">
        <div
          class="relative overflow-x-auto shadow-md sm:rounded-lg mt-2 border border-green-400 dark:border-gray-700"
        >
          <div
            class="flex justify-end w-full h-[32px] py-10 bg-white items-center border-b"
          >
            <div
              class="pr-5 w-[98%] flex justify-between"
              style="
                font-family: 'Montserrat-Arabic';
                font-size: 18px;
                font-weight: 500;
                      ...
                      <div class="modal-body">
                        <div class="bg-white rounded-xl w-full mx-auto">
                          ...
                          <div class="divide-y divide-gray-200">
                            <div
                              class="flex justify-end flex-col gap-7 items-end py-4"
                            >
                              <div
                                class="w-2/3 flex justify-between text-[#737373] items-center"
                              >
                              ...
                              >
                                ...
                                <h1>اختيار المطور العقاري</h1>
                              </div>
                            </div>
                            <div
                              class="w-full flex justify-around flex-wrap gap-6 py-4"
                            >
                              <div class="input-wrapper w-[45%]" dir="rtl">
                                <label for="inputField" class="label"
                                  >اسم الايقونة English
                                </label>
                                <input
                                  type="text"
                                  id="inputField"
                              ...
                              <div class="input-wrapper w-[45%]">
                                <label for="inputField_2" class="label">
                                  اللون الفرعي
                                </label>
                                <div
                                ...
                                >
                                  <input
                                    type="color"
                                    id="inputField_2"
                                    class="color-picker p-1 h-7 w-7 block bg-white cursor-pointer rounded-lg disabled:opacity-50 disabled:pointer-events-none"
                                  />
                                  <label for="inputField_2"> اختر لون </label>
                                </div>
                              </div>
                              <div class="input-wrapper w-[45%]">
                                <label for="inputField1" class="label">
                                  اللون الاساسي
                                </label>
                                <div
                                  class="input-field flex items-center justify-between"
                                >
                                  <input
                                    ...
                                    class="color-picker p-1 h-7 w-7 block bg-white cursor-pointer rounded-lg disabled:opacity-50 disabled:pointer-events-none"
                                  />
                                  <label for="inputField1"> اختر لون </label>
                                </div>
                              </div>
                              <div class="input-wrapper lg:w-[45%] w-full">
          ...
          <div class="w-[96%] mx-auto">
            <div
              class="w-full h-[50px] bg-[#F6F7F8] flex justify-between px-4 items-center gap-4 rounded-2xl my-3"
            >
              <button
                @click="this.TableState = 5"
                :class="[bt, { btnactive: this.TableState === 5 }]"
              >
                الخدمات التشغيلية
              </button>
              <button
                @click="this.TableState = 4"
                :class="[bt, { btnactive: this.TableState === 4 }]"
              >
                المرافق
              </button>
              <button
                @click="this.TableState = 3"
                :class="[bt, { btnactive: this.TableState === 3 }]"
              >
                أبرز المعالم القريبة
              </button>
              <button
                @click="this.TableState = 1"
                :class="[bt, { btnactive: this.TableState === 1 }]"
              >
                خدمات ما بعد البيع
              </button>
              <button
                class="bt"
                :class="[bt, { btnactive: this.TableState === 2 }]"
                @click="this.TableState = 2"
              >
                مميزات المشروع
              </button>
            </div>
