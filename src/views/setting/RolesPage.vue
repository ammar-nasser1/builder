  ...
  <div class="w-[100%] flex flex-col items-center justify-center">
    ...
    <div class="w-[96%] flex flex-col items-center">
      <div class="w-[100%] bg-white">
        <div
          class="relative overflow-x-auto shadow-md sm:rounded-lg mt-2 border-green-400 dark:border-gray-700"
        >
          <div class="w-[100%] mx-auto">
            <div
              class="w-[100%] bg-[#F6F7F8] border flex divide-x justify-end gap-6 px-4 items-center"
            >
              <div class="px-4 py-3">
                <button
          ...
          <div v-show="this.TableState === 1" class="p-20">
            <div
              class="flex flex-col gap-4 pb-8 justify-around w-full text-right"
            >
              <h1 class="text-xl font-bold">المستخدمين</h1>
              <h2 class="text-gray-500">
                تحديد صلاحيات الدخول والعمليات الخاصة بالنظام
              </h2>
            </div>
            <table
              class="min-w-full text-sm text-gray-500 border rounded-2xl rtl:text-right dark:text-gray-400"
            >
              <thead
                class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400 rounded-2xl border-b"
              >
                <tr class="border rounded-xl">
                  <th scope="col" class="px-6 py-3">نوع المستخدم</th>
                  <th scope="col" class="px-6 py-3">تصنيف المستخدم</th>
                  <th scope="col" class="px-6 py-3">تم الإنشاء في</th>
              ...
              <tbody>
                ...
                >
                  <td class="px-6 py-4 text-blue-600">سوبر ادمن</td>
                  <td class="px-6 py-4">صلاحية كاملة</td>
                ...
                <tr
                  class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600"
                >
                  <td class="px-6 py-4 text-blue-600">ادمن</td>
                  <td class="px-6 py-4">صلاحية كاملة</td>
                  <td class="px-6 py-4">2023/01/02</td>
                  <td class="px-6 py-4">
                    <input
                ...
                <tr
                  class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600"
                >
                  <td class="px-6 py-4 text-blue-600">مالك نظام</td>
                  <td class="px-6 py-4">صلاحية كاملة</td>
                  <td class="px-6 py-4">2023/01/02</td>
                  <td class="px-6 py-4">
                    <input
          ...
          <div v-show="this.TableState === 2" class="p-20">
            <div
              class="flex flex-col gap-4 pb-8 justify-around w-full text-right"
            >
              <h1 class="text-xl font-bold">المستخدمين</h1>
