<template>
  <div class="w-[100%] flex flex-col items-center">
    ...
    <div class="w-[96%]">
      <div
        class="w-full mx-auto md:px-96 h-[72px] bg-white flex-row flex justify-center items-center gap-4 rounded-xl shadow-sm my-5"
      >
        <div class="flex flex-col items-center">
          <div
            :class="{
              'bg-white text-gray-500 border-teal-600 border-2':
                $route.name === 'closeOrder',
            }"
            class="rounded-full h-7 w-7 flex p-2 items-center text-sm justify-center border-2 border-[#DDDDDD]"
          >
            5
          </div>
          <div
            class="text-xs mt-2"
            :class="{
              'text-teal-600': $route.name === 'closeOrder',
        ...
        <div
          ...
          :class="{
            'border-teal-600': $route.name === 'closeOrder',
          }"
        ></div>
        <div class="flex flex-col items-center">
          <div
            :class="{
              'bg-teal-600 text-white border-teal-600':
                $route.name === 'closeOrder',
              'bg-white text-gray-500  border-2 border-teal-600':
                $route.name === 'technicalReport',
            }"
            class="rounded-full h-7 w-7 flex p-2 items-center text-sm justify-center border-2 border-[#DDDDDD]"
          >
            4
        ...
        <div
          ...
          :class="{
            'border-teal-600':
              $route.name === 'technicalReport' || $route.name === 'closeOrder',
          }"
        ></div>
        <div class="flex flex-col items-center">
          <div
            :class="{
              'bg-teal-600 text-white':
                $route.name === 'technicalReport' ||
                $route.name === 'closeOrder',
              'bg-white text-gray-500 border-teal-600':
                $route.name === 'sendingTechnician',
            }"
            class="rounded-full h-7 w-7 flex p-2 items-center text-sm justify-center border-2 border-gray-300"
          >
            3
          </div>
          <div
          ...
          <div
            :class="{
              'bg-teal-600 text-white':
                ...
                $route.name === 'technicalReport' ||
                $route.name === 'closeOrder',
              'bg-white text-teal-600': $route.name === 'receivingOrder',
            }"
            class="rounded-full h-7 w-7 flex p-2 items-center text-sm justify-center border-2 border-gray-300"
          >
            2
          ...
          <div
            ...
            :class="{
              'text-teal-600':
                ...
                $route.name === 'technicalReport' ||
                $route.name === 'closeOrder' ||
                $route.name === 'receivingOrder',
              'text-gray-500': $route.name === 'receivingOrder',
            }"
          >
            استلام الطلب
          </div>
        ...
        <div
          ...
          :class="{
            'border-teal-600':
              ...
              $route.name === 'technicalReport' ||
              $route.name === 'closeOrder',
            'border-gray-300': $route.name === 'createOrder',
          }"
        ></div>
        <div class="flex flex-col items-center">
          <div
            :class="{
              'bg-teal-600 text-white':
                ...
                $route.name === 'technicalReport' ||
                $route.name === 'closeOrder',
              'bg-white text-teal-600': $route.name === 'createOrder',
            }"
            class="rounded-full h-7 w-7 flex p-2 items-center text-sm justify-center border-2 border-teal-600"
          >
            1
          </div>
          <div class="text-xs mt-2 text-teal-600">انشاء الطلب</div>
        </div>
      </div>
