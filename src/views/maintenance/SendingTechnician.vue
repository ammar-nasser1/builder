<template>
  <div class="mb-11">
    ...
    <input
      ...
      placeholder="Data 3"
    /> -->
    <div class="flex flex-col bg-white rounded-xl mt-12">
      <div
      ...
      <div class="w-full flex justify-between gap-5 items-center py-5 px-3">
        <button
          class="bg-[#F1F3F9] text-teal-600 rounded-[8px] px-2 w-[20%] py-2 ml-2"
        >
          إرسال الفني
        </button>
        <div class="input-wrapper lg:w-[45%] w-full">
          <label for="selectField" class="label"> اختيار الموظف</label>
          <select
            id="selectField"
        ...
        <div class="input-wrapper w-[45%]">
          <label for="inputField" class="label"> الحهة المختصة</label>
          <input
            type="text"
            id="inputField"
            class="input-field"
        ...
        >
          ...
          <tbody>
            ...
            >
              ...
              <td class="px-6 py-4">010665606</td>
              <td class="px-6 py-4">ammar</td>
              <td class="px-6 py-4">ammar</td>
              <td class="px-6 py-4">ammar</td>
              <td class="px-6 py-4">ammar</td>
            </tr>
    ...
    <div class="w-full flex justify-start gap-3">
      <button
        @click="navigateTo('technicalReport')"
        class="bg-[#3C757D] text-white shadow-sm rounded-[8px] px-14 py-3 ml-2 mt-16"
      >
        التالي
      </button>
      <button
        @click="navigateTo('receivingOrder')"
        class="border-[#3C757D] border text-teal-600 shadow-sm rounded-[8px] px-14 py-3 ml-2 mt-16"
      >
        السابق
      </button>
    </div>
