<template>
  <div class="w-[100%] flex flex-col items-center justify-center">
    ...
    <div class="w-[96%] flex flex-col items-center">
      ...
      >
        <div
          class="w-[100%] md:w-[24%] h-[150px] bg-[#FFFFFF] flex flex-col justify-evenly px-[18px] py-2 rounded-[16px]"
        >
      ...
      <div class="flex justify-between w-[100%]">
        <div
          class="container mt-5 bg-[#FFFFFF] rounded-2xl w-[100%] md:w-[24%]"
        >
          <h2 class="mb-4 text-center">أكثر 10 وحدات</h2>
          <Doughnut
            id="my-chart-id"
        ...
        <div
          class="container mt-5 bg-[#FFFFFF] rounded-2xl w-[100%] md:w-[24%]"
        >
          <h2 class="mb-4 text-center">أكثر 10 مشاريع</h2>
          <Doughnut
            id="my-chart-id"
            :options="chartOptions"
            :data="chartData"
        ...
        <div
          class="container mt-5 w-[100%] md:w-[24%] bg-[#FFFFFF] rounded-2xl"
        >
          <h2 class="mb-4 text-center">أفضل 10 موظفي مبيعات</h2>
          <Doughnut
            id="my-chart-id"
            :options="chartOptions"
            :data="chartData"
        ...
        <div
          class="container mt-5 w-[100%] md:w-[24%] bg-[#FFFFFF] rounded-2xl"
        >
          <h2 class="mb-4 text-center">أكثر 10 مصادر</h2>
          <Doughnut
            id="my-chart-id"
            :options="chartOptions"
            :data="chartData"
