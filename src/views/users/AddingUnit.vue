<template>
  <div>
    ...
    /> -->
      ...
      <div
        class="w-full flex justify-end items-end pt-3 divide-y divide-solid flex-col gap-6 bg-white"
      >
        <div class="w-[97%] mx-auto flex flex-col items-end gap-4 py-4">
          <h1
            style="
              font-family: Montserrat-Arabic;
              font-size: 16px;
        ...
        <div class="w-[97%] mx-auto flex justify-end">
          <div class="w-[90%] flex justify-between flex-wrap py-8">
            <div class="flex flex-col w-1/2 justify-start gap-9">
              <div class="flex justify-between w-[95%]">
                <div class="input-wrapper lg:w-[50%] sm:w-full">
                  <label for="inputField" class="label"> المساحة الي</label>
                  <input
                    type="text"
                    id="inputField"
                    class="input-field"
                ...
                <div class="input-wrapper lg:w-[45%] sm:w-full">
                  <label for="inputField" class="label"> المساحة من</label>
                  <input
                    type="text"
                    id="inputField"
                    class="input-field"
              ...
              <div class="input-wrapper lg:w-[95%] w-full">
                <label for="selectField" class="label"> الدور </label>
                <select
                  id="selectField"
                  class="select-field w-full"
                  v-model="selectedCountry"
                >
                  <option value="" disabled selected>ارضي</option>
                  <option
                    v-for="option in options"
                    :value="option.value"
                    :key="option.value"
            ...
            <div class="flex flex-col w-1/2 items-end justify-center gap-9">
              <div class="input-wrapper lg:w-[95%] w-full">
                <label for="selectField" class="label"> عدد غرف النوم </label>
                <select
                  id="selectField"
                  class="select-field w-full"
                  v-model="selectedCountry"
                >
                  <option value="" disabled selected>مثال 3 غرف</option>
                  <option
                    v-for="option in options"
                    :value="option.value"
                    :key="option.value"
              ...
              <div class="input-wrapper lg:w-[95%] w-full">
                ...
                <select
                  ...
                  v-model="selectedCountry"
                >
                  <option value="" disabled selected>مثال :غرف الغسيل</option>
                  <option
                    v-for="option in options"
                    :value="option.value"
                    :key="option.value"
              ...
              <div class="input-wrapper lg:w-[95%] w-full">
                <label for="selectField" class="label"> المواقف</label>
                <select
                  id="selectField"
                  class="select-field w-full"
                  v-model="selectedCountry"
    ...
    <div class="bg-white my-5 rounded-xl w-[96%] mx-auto">
      <!-- Header -->
      <div
        class="flex justify-end h-[32px] py-10 bg-white items-center border-b"
      >
      ...
      <div class="py-6 mr-6">
        ...
        >
          <div class="w-[30%] gap-3 flex flex-col">
            <h1 class="text-right text-lg">هل لديك اعفاء ضريبي</h1>
          ...
          <transition name="fade">
            <div class="w-full py-1 upfile" v-show="showUpfile">
              <div class="w-[97%] mx-auto flex flex-col items-end gap-4 py-4">
                ...
                <div class="input-wrapper lg:w-[43%] w-full">
                  <label for="selectField" class="label"> اختار المشروع</label>
                  <select
                    id="selectField"
                    class="select-field w-full"
                    v-model="selectedCountry"
