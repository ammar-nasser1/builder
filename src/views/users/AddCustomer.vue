<template>
  <div class="w-[100%] flex flex-col items-center">
    ...
    <div class="w-[96%]">
      <div
        class="w-full pr-[30px] h-[72px] bg-white flex-row-reverse flex justify-start items-center gap-4 rounded-s-xl shadow-xl my-8"
      >
        <button
          :class="[bt, { btnactive: $route.name === 'CustPrimaryData' }]"
          @click="navigateTo('CustPrimaryData')"
        >
          البيانات الأولية
        </button>
        <button
          @click="navigateTo('certifiedCust')"
          :class="[bt, { btnactive: $route.name === 'certifiedCust' }]"
        >
          شهادة الاعفاء الضريبي
        </button>
        <button
          @click="navigateTo('cust-unit')"
          :class="[bt, { btnactive: $route.name === 'cust-unit' }]"
        >
          الوحدات
        </button>
        <button
          @click="navigateTo('potentail-units')"
          :class="[bt, { btnactive: $route.name === 'potentail-units' }]"
        >
          الوحدات المحتملة
        </button>
      </div>
