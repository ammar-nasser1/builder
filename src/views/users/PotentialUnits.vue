<template>
  <div class="bg-white my-4 rounded-xl">
    <div
      class="flex justify-end h-[32px] py-10 bg-white items-center rounded-se-xl rounded-ss-xl border-b"
    >
      <div
        class="pr-5"
        style="
    ...
    >
      ...
      <p>لا توجد وحدات مهتمة من طرف العميل</p>
      <button
