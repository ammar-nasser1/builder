<template>
  <div class="w-[100%] flex flex-col items-center justify-center">
    ...
    <div class="w-[96%] flex flex-col items-center">
      <div
        class="flex lg:justify-between justify-center flex-wrap items-center w-[100%] gap-1"
      >
        <div
          class="w-[100%] md:w-[23.5%] h-[150px] bg-[#FFFFFF] flex flex-col justify-evenly px-[18px] py-2 rounded-[16px]"
        >
...
export default {
  ...
  methods: {
    ...
    goToCreateOrder() {
      ...
      this.$router.push("/add-rental/create-order-rental");
    },
  },
  mounted() {},
};
