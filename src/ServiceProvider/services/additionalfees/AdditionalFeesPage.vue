<template>
  <div class="w-[100%] flex flex-col items-center justify-center">
    ...
    <div class="w-[96%] flex flex-col items-center">
      ...
      >
        <div class="w-[100%] justify-between flex flex-wrap gap-2">
          <div
            v-for="card in [1, 2]"
            :key="card.id"
            ...
            <tbody>
              ...
              >
                ...
                <td
                  ...
                  @click="navigateTo('ShowAdditionalFees')"
                >
                  <svg
                    width="24"
                    height="24"
    ...
    return {
      ...
      breadcrumb: {
        ...
        btn: {
          isfuc: false,
          isbtn: true,
          name: "إضافة رسوم إضافية",
          route: "AddAdditionalFees",
        },
      },
    };
  },
