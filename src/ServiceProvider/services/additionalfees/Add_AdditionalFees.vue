    ...
    return {
      ...
      breadcrumb: {
        ...
        btn: {
          isfuc: false,
          isbtn: true,
          name: "حفظ الرسم الإضافي",
          route: "AddClassification",
        },
      },
      formData: {
        name: "بيانات الرسم الإضافي",
        datafeild: [
          {
            label: "اسم الرسم الإضافي بالإنجليزية",
            type: "text",
            model: "",
            placeholder: "مثال: أحمد محمد فريد غنيم",
          },
          {
            label: "قيمة الرسم الإضافي",
            type: "text",
            model: "",
            placeholder: "مثال: 5",
          },
          {
            label: "اسم الرسم الإضافي بالعربية",
            type: "text",
            model: "",
            placeholder: "مثال: أحمد محمد فريد غنيم",
          },
          {
            label: "نوع الرسم الإضافي",
            type: "select",
            model: "",
            options: [
            ...
            placeholder: "اختر نوع الرسم الإضافي...",
          },
        ],
      },
      tabledata: {
