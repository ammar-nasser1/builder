      ...
      >
        <div class="w-[90%] mx-auto">
          ...
          >
            ...
            >
              إضافة خدمات
              <img src="/img/icons/chart-square.png" alt="" class="px-2" />
            </button>
          </div>
        </div>
      </div>
        ...
        <div class="w-[90%]">
          ...
          >
            <div class="input-wrapper lg:w-[45%] w-full">
              ...
              <select id="selectField" class="select-field w-full">
                <option value="" disabled selected>موقف خارجي</option>
                <option
    ...
    <div class="mb-11 w-[97%] mx-auto">
      ...
      >
        <div class="w-[90%]">
          ...
          >
            <div class="input-wrapper lg:w-[45%] w-full">
              <label for="selectField" class="label">العقارات </label>
              <select id="selectField" class="select-field w-full">
                <option value="" disabled selected>موقف خارجي</option>
                <option
                  v-for="option in options"
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="bg-white rounded-xl w-full mx-auto">
              ...
              <!-- Main content -->
              <the-table :tabledata="tabledata" class="" />
            </div>
          </div>
        ...
        datafeild: [
          {
            ...
            type: "text",
            model: "",
            placeholder: "1531321321",
            readonly: true, // Assuming the offer code is not editable
          },
          {
          ...
          },
          {
            ...
            type: "date",
            model: "",
            placeholder: "مثال: 7 أكتوبر 2023",
          },
          {
          ...
          },
          {
            ...
            model: "",
            options: [
              { value: "1", label: "مثال: نسبة مئوية" },
              { value: "2", label: "مثال: قيمة ثابتة" },
            ],
