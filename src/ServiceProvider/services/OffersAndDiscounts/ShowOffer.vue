<template>
  <div class="">
    ...
    <div class="w-[97%] mx-auto mb-4 justify-between flex flex-wrap gap-2">
      <div
        v-for="card in [1, 2, 3]"
        :key="card.id"
        class="w-[100%] md:w-[32%] h-[150px] bg-[#FFFFFF] flex flex-col justify-evenly px-[18px] py-2 rounded-[16px]"
      >
      ...
      >
        <div class="w-[90%]">
          ...
          >
            ...
            <div class="w-[40%] flex gap-3 justify-end items-center">
...
export default {
  data() {
    return {
      ...
      formData: {
        name: "بيانات قطعة الغيار",
        datafeild: [
          {
            label: "اسم قطعة الغيار بالإنجليزية",
            type: "text",
            model: "",
          ...
          },
          {
            ...
            type: "text",
            model: "",
            placeholder: "ادخل الكمية الموجودة بالمخزن",
          },
          {
            label: "اسم قطعة الغيار بالعربية",
            type: "text",
            model: "",
            placeholder: "مثال: أحمد محمد فريد غنيم",
          },
          ...
          },
          {
            ...
            model: "",
            options: [
              { value: "1", label: "مثال: بالكغ" },
              { value: "2", label: "مثال: بالطن" },
              { value: "3", label: "مثال: بالمتر" },
            ],
      ...
      tabledata: {
        ...
        data: [
          {
            ExecutionOrderRecord: "عرض التفاصيل",
            ExecutionOrder: "",
            ExecutedBy: "Ayad Sharif",
            OrderStatus: "Transfer to Maintenance Company",
            TechnicianName: "Maintenance Company",
            ConcernedDepartment: "Plumbing",
            ProblemIdentification: "Transfer to Maintenance Company",
            ExecutionTime: "25 October 2023 - 10:00 AM",
          },
        ],
      },
