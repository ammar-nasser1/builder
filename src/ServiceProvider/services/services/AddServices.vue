<template>
  <div class="">
        ...
        <div class="flex w-[96%]">
          ...
          >
            <div class="flex gap-2 justify-end">
              ...
              <span>&lt;</span>
              <span class="text-[#2F6FED]">المستوى الثاني</span>
              <span>&lt;</span>
      ...
      >
        <div class="w-[90%]">
          <div
            class="form-section w-full flex flex-wrap items-center justify-between flex-row-reverse gap-5"
          >
            <div class="input-wrapper w-full md:w-[100%]">
              <label for="inputField" class="label">وصف التصنيف</label>
              <textarea
                id="inputField"
      ...
      >
        <div class="w-[90%]">
          <div
            class="form-section w-full flex flex-wrap items-center justify-between flex-row-reverse gap-5"
          >
            <div class="w-[20%] flex gap-3 justify-end items-center">
              <label for="inputFieldc" class=""> عرض على الموظفين؟</label>
              <input
                type="checkbox"
                id="inputFieldc"
                class="rounded-lg h-6 w-6 border-2 border-gray-300 shadow-sm focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-100 focus:ring-indigo-500"
                v-model="Showtoemployees"
              />
            </div>
            <div class="w-[20%] flex gap-3 justify-end items-center">
              <label for="inputFieldc" class=""> عرض على الموظفين؟</label>
    ...
    <div class="flex w-[97%] flex-col h-[308px] gap-5 bg-white rounded-xl">
      <div
      ...
      <div class="w-full flex justify-end gap-5 items-center rounded-xl px-3">
        <div
...
export default {
        ...
        datafeild: [
          {
            ...
            model: "",
            options: [
              { value: "1", label: "مثال: تصليح إلكترونيات" },
              { value: "2", label: "مثال: تصليح كهرباء" },
              { value: "3", label: "مثال: تصليح سيارات" },
            ],
          ...
          },
          {
            ...
            type: "text",
            model: "",
            placeholder: "مثال: أحمد محمد فريد غنيم",
          },
          {
            label: "نوع السعر",
            type: "select",
            model: "",
            options: [
              { value: "1", label: "مثال: ثابت" },
              { value: "2", label: "مثال: متغير" },
            ],
          ...
          },
          {
            ...
            model: "",
            options: [
              { value: "5", label: "مثال: 5%" },
              { value: "10", label: "مثال: 10%" },
              { value: "15", label: "مثال: 15%" },
            ],
          ...
          },
          {
            ...
            model: "",
            options: [
              { value: "1", label: "مثال: نشط" },
              { value: "2", label: "مثال: غير نشط" },
            ],
          ...
          },
          {
            ...
            model: "",
            options: [
              { value: "1", label: "مثال: سنة واحدة" },
              { value: "2", label: "مثال: سنتان" },
              { value: "3", label: "مثال: ثلاث سنوات" },
            ],
          ...
          },
          {
            ...
            model: "",
            options: [
              { value: "1", label: "مثال: كهرباء" },
              { value: "2", label: "مثال: سباكة" },
              { value: "3", label: "مثال: بناء" },
            ],
          ...
          },
          {
            ...
            model: "",
            options: [
              { value: "1", label: "مثال: أونلاين" },
              { value: "2", label: "مثال: زيارة ميدانية" },
            ],
          ...
          },
          {
            ...
            model: "",
            options: [
              { value: "1", label: "مثال: ضمان جزئي" },
              { value: "2", label: "مثال: ضمان كامل" },
            ],
          ...
          },
          {
            ...
            model: "",
            options: [
              { value: "1", label: "مثال: نوع الصيانة 1" },
              { value: "2", label: "مثال: نوع الصيانة 2" },
            ],
  ...
  methods: {
    ...
    sendData() {
      ...
      formData.append("name", this.formData.datafeild[1].model);
      formData.append("name_en", this.formData.datafeild[2].model);
      formData.append("icon", this.formData.datafeild[0].model);
      formData.append("description", this.descriptions);
      for (const value of formData.values()) {
        console.log(value);
      }
      this.showAlert("تم اضافة التصنيف بنجاح", "success");
    },
  },
  mounted() {},
};
