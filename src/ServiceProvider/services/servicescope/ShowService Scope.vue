<template>
  <div class="">
    ...
    <div class="w-[97%] mx-auto justify-between mb-8 flex flex-wrap gap-2">
      <div
        v-for="card in [1, 2, 3]"
        :key="card.id"
    ...
    <div class="mb-11 w-[97%] mx-auto">
      ...
      <div
        class="w-full flex justify-end items-end rounded-xl lg:px-4 flex-col gap-12 bg-white"
      >
      ...
      formData: {
        ...
        datafeild: [
          ...
          },
          {
            ...
            model: "",
            options: [
              { value: "1", label: "مثال: نوع 1" },
              { value: "2", label: "مثال: نوع 2" },
            ],
            placeholder: "اختر النوع المختص...",
          },
        ],
      },
      tabledata: {
