  ...
  <div class="w-[100%] flex flex-col items-center">
    ...
    <div class="w-[96%]">
      ...
      <div class="flex flex-col h-[308px] gap-5 bg-white rounded-xl">
        <div
          class="flex rounded-se-xl rounded-ss-xl justify-end h-[32px] py-10 bg-white items-center border-b"
        >
          <div
            class="pr-5"
            style="
        ...
        <div
          class="w-full flex justify-end xl:gap-5 lg:gap-2 items-center rounded-xl p-4"
        >
          <div
