<template>
  <div class="w-[100%] flex flex-col items-center justify-center">
    ...
    <div class="w-[96%] flex flex-col items-center">
      <div
        class="flex lg:justify-between justify-center gap-4 flex-wrap items-center w-[100%]"
      >
        <AnalyticalCards
          v-for="card in cards"
          :key="card.id"
...
<script>
const tabledata = require("/public/data/paymentsdata.json");
import AnalyticalCards from "@/components/AnalyticalCards.vue";
...
export default {
      ...
      cards: [
        {
          ...
          cardNum: "580",
          cardHeader: "+16,5 %",
          cardFoot: "مقارنة بالشهر السابق (750)",
        },
        {
          id: 2,
          cardName: "العملاء",
  ...
  components: { AnalyticalCards, Table },
  methods: {
    navigateTo(route) {
